...
4. Using `dbc` user, we will create a new database called `HR`. Copy/paste this query and run it by hitting the run query button (![Run Query Button](../images/run.query.button.png)) or pressing <kbd>[F5]</kbd> key:
