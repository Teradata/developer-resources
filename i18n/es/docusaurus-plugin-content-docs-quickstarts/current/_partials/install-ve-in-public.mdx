...
* Recupere el comando curl para descargar Vantage Express.
    ...
    * En la vista de red, busque la última solicitud que comience con `VantageExpress`. Haga clic con el botón clic derecho sobre el elemento y seleccione `Copy -> Copy como cURL`:
