...
export const FeatureList = [
  ...
  },
  {
    ...
    descriptionLink: translate({ message: 'developers.downloads_link' }),
...
export const FeatureList2 = [
  {
    img: 'developer_board',
    img2: 'open_in_new',
    title: translate({ message: 'developers.top-picks-from-teradata-title-card1' }),
    description: translate({ message: 'developers.top-picks-from-teradata-text-card1' }),
