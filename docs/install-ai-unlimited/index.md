...
Now you're ready to install AI Unlimited on [AWS](../install-ai-unlimited/prod-aws-console-deploy-ai-unlimited.md) or [Azure](../install-ai-unlimited/prod-azure-portal-deploy-manager.md).
