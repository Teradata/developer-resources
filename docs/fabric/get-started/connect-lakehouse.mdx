...
# Connect to the sample lakehouse - Test
...
Let’s connect to the AIUnlimited\_Demo lakehouse that was just created.

![ImgConnectLakehouse](./connect-lakehouse.svg)

Select  “+Lakehouse.”

Select the AIUnlimited\_Demo lakehouse and then “Connect” in the lower right.
