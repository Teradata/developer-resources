...
:::note
If you don't have JupyterLab or the AI Unlimited kernel, see [JupyterLab installation options](../resources/jupyterlab).
:::
...
## Ways to learn
- See the overall [project flow](./project-flow.md)
- Explore [sample use cases](./example-projects.md)&mdash;and try them out
- Get details on AI Unlimited [magic commands](./magic-commands.md)
...
:::note
To avoid paying for unneeded engine resources, remember to [suspend](../manage-ai-unlimited/suspend-and-restore-project.md) projects you're not working on.
:::
