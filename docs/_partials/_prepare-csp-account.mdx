...
title: Step 1-Prepare your Cloud Service Provider account
...
***If we keep the bullet about getting a CSP account in Before you begin, we can remove it from this topic.***


- The account deploying workspace service ***["Your AWS account..."]*** must have sufficient IAM permissions to create IAM roles or IAM policies. See xref::ai-unlimited-aws-permissions-policies.adoc[to be updated].
...
***MEM: Getting the CLI could also be in Before you begin--just like what we did for the QS Before you begin.***
